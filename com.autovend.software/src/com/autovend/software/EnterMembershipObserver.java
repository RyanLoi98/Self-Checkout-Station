...
/**
 * Observer of EnterMembership
 */
public interface EnterMembershipObserver {
    /**
     * Announces the amount of points to the customer
     */
    void updatePoints(int points);

    /**
     * Announces if the membership database is corrupt (was not loaded properly) to the customer
     */
    void isDataBaseCorrupt(boolean status);
    
    void memberCardEvent(String cardNumber);
    
    void swipeAttemptEvent();
