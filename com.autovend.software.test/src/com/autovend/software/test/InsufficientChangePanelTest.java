...
public class InsufficientChangePanelTest {
    JPanel dummyPanel;
    InsufficientChangePanel insufficientChangePanel;
    ...
    @Before public void setup(){
        ...
        insufficientChangePanel = new InsufficientChangePanel(dummyPanel, customerIO);

        
        frameWidth = 800;
        frameHeight = 600;
        welcomePanel = new WelcomePanel(customerIO, frameWidth, frameHeight);
        popupTitle = insufficientChangePanel.getPopupTitle();
        changeDue = insufficientChangePanel.getChangeDue();
        popupBody = insufficientChangePanel.getPopupBody();

    }
    @After public void teardown(){
        dummyPanel = null;
        insufficientChangePanel = null;
        popupTitle = null;
        popupBody = null;
        welcomeButton = null;
    }
    ...
    @Test public void defaultLabelTest(){
        Assert.assertEquals("Please wait, not enough change.", popupTitle.getText());
        Assert.assertEquals("$0 owed.", changeDue.getText());
        Assert.assertEquals("An attendant will help shortly.", popupBody.getText());
    }
